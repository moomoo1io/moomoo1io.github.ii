...
// @namespace      -
// @version          ╳0.4╳
// @description    2шипа и 1буст(или ловушка)-G,Fps,Изменение шапок в зависимости от части карты,Много мельниц-O,Ловушка или буст-F,Лавушка или буст-F,Шипы вокруг себя-ж,Большой магазин,Особая карта,мельница-NШип-V,Авто клан стрелка вниз ▼,Авто сообщение стрелка вверх ▲,Инста килл(удар 2 орудиями)-R,С лева вверху дискорд сервер HA$,Esc можешь менять шапки
// @author         JS_king_OVI
// @match          *://moomoo.io/*
// @match          *://dev.moomoo.io/*
...
$('#menuContainer').append('Вы играете с скриптами js!')
$("#youtuberOf").css({display: "король{Kr}(imperator{Kr})"});
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">Настройки</h2>
        </div>
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
<label class="container">Премиум карта
        ...
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
<label class="container">Больше ФПС
                    <input type="checkbox" id="myCheck" checked>
                    <span class="checkmark"></span>
                </label>
            </div>
        ...
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
                <h3 style="color: black; font-size: 17px;">Коды шляп</h3>
                <h3 class="menuPrompt">Шляпа танка : </h3> <input value="${String.fromCharCode(TankGearKey)}" id="tankGear" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Шляпа быка : </h3> <input value="${String.fromCharCode(BullHelmetKey)}" id="bullHelm" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Шляпа солдата : </h3> <input value="${String.fromCharCode(SoldierHelmetKey)}" id="soldier" class="keyPressLow"onkeyup="this.value = this.value.toUpperCase();"  maxlength="1" type="text"/>
                <h3 class="menuPrompt">Шляпа турель : </h3> <input value="${String.fromCharCode(TurretKey)}" id="turret" class="keyPressLow" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" type="text"/>
                <h3 class="menuPrompt">Шляпа ускорения : </h3> <input value="${String.fromCharCode(BoosterHatKey)}" id="booster" class="keyPressLow" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" type="text"/>
                <h3 class="menuPrompt">Шипастая шляпа : </h3> <input value="${String.fromCharCode(SpikeGearKey)}" id="spikeg" class="keyPressLow" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" type="text"/>
                <h3 class="menuPrompt">Снять шляпу : </h3> <input value="Shift" id="spikeg" class="keyPressLow" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" type="text"/>
                <h3 style="color: black; font-size: 17px;">Коды читов</h3>
                <h3 class="menuPrompt">2шипа и 1буст(или ловушка) : </h3> <input value="G" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Много мельниц : </h3> <input value="O" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Ловушка или буст : </h3> <input value="F" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Шипы вокруг себя : </h3> <input value=":(Ж)" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Мельница перед собой : </h3> <input value="N" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Шип перед мобой : </h3> <input value="V" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Авто сообщение стрелка вверх : </h3> <input value="▲" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Авто клан стрелка вниз : </h3> <input value="▼" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Инста килл(удар 2 орудиями) : </h3> <input value="R" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <h3 class="menuPrompt">Это меню : </h3> <input value="Esc" id="barb" class="keyPressLow" onkeyup="this.value = this.value.toUpperCase();" maxlength="1" type="text"/>
                <hr>
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 106 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Реген - OFF | Шляпа - OFF"
            } else {
                document.title = "Реген - OFF | Шляпа - ON"
            }
        } else {
            if(hatToggle == 0) {
    ...
    if(e.keyCode == 111 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Реген - off|"
            } else {
                document.title = "Реген - off|"
            }
        } else {
            if(hatToggle == 0) {
                document.title = "Реген - on|"
            } else {
                document.title = "Реген - on|"
            }
        }
